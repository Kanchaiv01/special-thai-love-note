            ...
            <Card className="max-w-5xl mx-auto bg-white/70 backdrop-blur-xl border-0 shadow-2xl rounded-3xl overflow-hidden">
              <CardContent className="p-12">
                <div className="text-slate-700 leading-relaxed text-xl space-y-6 font-light">
                  ...
                  <div className="block">แต่เชื่อมั้ย... ถ้าพี่ได้ลองเปิดใจรับอะไรสักอย่างเข้ามาในชีวิตแล้วล่ะก็</div>
                  <div className="block">พี่จะตั้งใจและทุ่มเทให้สิ่งนั้นมากๆ เลยนะ ทำได้ทุกวันไม่มีเบื่อเลยแหละ!</div>
                  <div className="block">พี่ชอบค้นหาความสุขจากสิ่งเล็กๆ น้อยๆ รอบตัวเสมอ และมีความสุขกับการได้แบ่งปันรอยยิ้มให้กับคนรอบข้าง</div>
                  ...
                  <div className="block text-slate-500 italic text-lg">(หวังว่าแกคงไม่ว่ากันนะ)</div>
                  <div className="block">ทักษะการเข้าสังคมพี่อาจจะไม่ได้โดดเด่นมากนัก เลยมีเพื่อนสนิทแค่กลุ่มเล็กๆ</div>
                  <div className="block">ที่รู้ใจกันจริงๆ ซึ่งนั่นก็ทำให้พี่ได้ใช้เวลากับคนที่สำคัญอย่างเต็มที่</div>
                  <div className="block">บางทีคำที่พูดออกไปบางคำก็อาจจะพูดห้วนๆไปบ้าง ปากจัดไปบ้างขอโทษนะ</div>
                  <div className="block">ปกติพี่ไม่ค่อยชอบเล่นโซเชียลเลยนะ...</div>
                  <div className="block">แต่ถ้าเมื่อไหร่ที่พี่เริ่มเล่นมากขึ้นมากๆ ล่ะก็ เหตุผลทั้งหมดก็คงเป็นเพราะแกนั่นแหละ 😉</div>
            ...
            <Card className="mt-12 mx-auto max-w-5xl bg-gradient-to-r from-pink-50/80 to-red-50/80 backdrop-blur-xl border-l-4 border-red-400 shadow-2xl animate-fade-in rounded-3xl overflow-hidden">
              <CardContent className="p-12">
                <div className="text-slate-700 text-xl leading-relaxed space-y-6 italic font-light">
                  <p>
                    ตั้งแต่ครั้งแรกที่เราได้คุยกัน พี่ก็รู้สึกได้ถึงความพิเศษในตัวอัง
                    เสียงหัวเราะของอังก็เป็นเหมือนเสียงเพลงที่ไพเราะที่สุด
                  </p>
                  <p>
                    พี่รู้ว่านี่อาจจะดูแปลกไปหน่อย แต่พี่อยากให้อังรู้ว่าพี่กำลังคิดถึงอังอยู่เสมอ
                    และหวังว่าในอนาคต เราจะมีโอกาสได้สร้างเรื่องราวดีๆ ร่วมกันนะครับ
                    อังคือแรงบันดาลใจที่ทำให้พี่อยากเป็นคนที่ดีขึ้นในทุกๆ วัน
                  </p>
